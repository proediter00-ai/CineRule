...
object InAppUpdater {
    // CineRule: Point to our own GitHub repo for in-app updates
    private const val GITHUB_USER_NAME = "proediter00-ai"
    private const val GITHUB_REPO = "CineRule"
    ...
    private suspend fun Activity.getAppUpdate(installPrerelease: Boolean): Update {
        return try {
            when {
                // CineRule: Allow updates even on debug builds
